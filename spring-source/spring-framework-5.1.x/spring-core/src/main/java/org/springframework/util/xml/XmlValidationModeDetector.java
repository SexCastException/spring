...
public class XmlValidationModeDetector {
	...
	/**
	 * 在提供的{@link InputStream}中检测XML文档的验证模式。<br>
	 * 判断是否包含“DOCTYPE”，包含则是DTD验证模式，否则就是XSD验证模式 <br>
	...
	/**
	 * 判断指定字符串是否包含 {@link XmlValidationModeDetector#DOCTYPE}字符串
