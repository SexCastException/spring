...
/**
 * 配置类，保存了配置的相关信息，配置类并不单单指加了 {@link Configuration}注解的类，还有加了 {@link Import}、
 * {@link ImportResource}、{@link ComponentScan}等注解以及方法上加了 {@link Bean}注解的类都属于配置类，
 * 只不过加了 {@link Configuration}的为全配置类，标识为full，其他配置类标识为lite
 * <p>
