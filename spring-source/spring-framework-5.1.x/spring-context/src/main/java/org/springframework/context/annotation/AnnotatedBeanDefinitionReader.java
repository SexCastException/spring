...
public class AnnotatedBeanDefinitionReader {
	 ...
	 *                              in addition to qualifiers at the bean class level <br>
	 *                              处理类级别上的特定限定符注解，还可以通过传参方式制定特殊限定符注解；
	 *                              特殊限定符注解包含：{@link Primary}、{@link Lazy}、{@link Qualifier}
	...
	/**
	 * 如果可能，从给定 {@link BeanDefinitionRegistry}获取 {@link Environment}，否则返回一个 {@link StandardEnvironment}<br>
	 * <p>
