...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	/**
	 * 注解方式的 {@link BeanDefinition}读取器
	 */
	private final AnnotatedBeanDefinitionReader reader;

	/**
	 * classpath下的 {@link BeanDefinition}扫描器
	 */
	 ...
	 *                         {@link Configuration @Configuration} classes <br>
	 *                         javaconfig方式的配置类对象
	 */
	public AnnotationConfigApplicationContext(Class<?>... componentClasses) {
		// 调用默认构造方法初始化 AnnotatedBeanDefinitionReader 和 ClassPathBeanDefinitionScanner对象
		this();
	...
	public void setBeanNameGenerator(BeanNameGenerator beanNameGenerator) {
		...
		// 用户自定义的beanName生成器的beanName是AnnotationConfigUtils.CONFIGURATION_BEAN_NAME_GENERATOR
	...
	/**
	 * 注册一个或多配置类或者bean，必须在此之后需要调用 {@link #refresh()}方法 <br>
	 * <p>
